import {Avatar, Link, Subtitle2, Title1} from "@fluentui/react-components";
        ...
        <div className={"flex flex-col gap-2"}>
            ...
            <div className={"flex flex-col gap-2 mx-36"}>
                ...
                <div className={"flex gap-8 overflow-x-scroll justify-around scrollbar-hide rounded-lg"}>
                    {
                        [...Array(5)].map((e, i) => (
                            <div key={i} className={"flex flex-col flex-wrap gap-1 justify-center items-center"}>
                                <Avatar size={48} color={"colorful"} name={"Yassine Mouddene"}/>
                                <span className={"text-lg "}>Yassine Mouddene</span>
                            </div>
                        ))
                    }
                </div>
